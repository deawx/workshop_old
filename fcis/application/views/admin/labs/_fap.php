<?php echo form_fieldset('FAP'); ?>
<div class="form-group">
  <?php echo form_label('APC ยีนส์:','apc',array('class'=>'control-label col-md-2')); ?>
  <div class="col-md-10">
    <div class="checkbox">
      <?php echo form_checkbox(array('name'=>'apc','class'=>'form-control','id'=>'checkbox_apc'),'1',set_checkbox('apc','1',($labs['apc'] == '1'))); ?>
    </div>
  </div>
</div>
<div id="apc_ctn">
...
<div class="form-group">
  <?php echo form_label('MUTYH GENE:','mutyh',array('class'=>'control-label col-md-2')); ?>
  <div class="col-md-10">
    <div class="checkbox">
      <?php echo form_checkbox(array('name'=>'mutyh','class'=>'form-control','id'=>'checkbox_mutyh'),'1',set_checkbox('mutyh','1',($labs['mutyh'] == '1'))); ?>
    </div>
  </div>
</div>
<div id="mutyh_ctn">
...
<div class="form-group">
  ...
  <div class="col-md-10">
    <div class="checkbox">
      <?php echo form_checkbox(array('name'=>'negative','class'=>'form-control','id'=>'negative'),'1',set_checkbox('negative','1',($labs['negative'] == '1'))); ?>
    </div>
  </div>
</div>
