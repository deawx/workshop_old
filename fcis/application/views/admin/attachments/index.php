      ...
      <div class="box-body">
        ...
        <div class="list-group">
          <?php foreach ($results as $key => $value): ?>
            <a href="<?php echo site_url('admin/attachments/view/'.$value['id']); ?>" class="list-group-item">
              <h4 class="list-group-item-heading">
                <?php echo $value['title'].nbs().$value['firstname'].nbs().$value['lastname']?>
                <small class="text-mute">(H.N. : <?php echo $value['hn']; ?>)</small>
    ...
    <div class="box box-info">
      ...
      <div class="box-footer clearfix">
        ...
        <span class="pull-right">
          <?=form_submit('','บันทึกข้อมูล',array('class'=>'btn btn-success','autocomplete'=>'off','disabled'=>TRUE));?>
        </span>
      </div>
    </div>
  </div>
