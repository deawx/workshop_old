			...
			<input type="hidden" name="id" value="<?php echo $group['id']?>">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?=form_input(array('name'=>'name','class'=>'form-control','placeholder'=>'ชื่อกลุ่ม'),set_value('name',$group['name']));?>
						</div>
					</div>
					<div class="form-group">
						<label for="" class="control-label col-md-3">คำอธิบายกลุ่ม</label>
						<div class="col-md-9">
							<?=form_input(array('name'=>'description','class'=>'form-control','placeholder'=>'คำอธิบายกลุ่ม'),set_value('description',$group['description']));?>
						</div>
					</div>
				</div><!-- /.box-body -->
