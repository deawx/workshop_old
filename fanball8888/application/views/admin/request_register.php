...
<div id="page-wrapper" >
  ...
  <div id="page-inner">
    <div class="row">
      <div class="col-sm-12">
        <legend>ฟอร์มรายการ ลงทะเบียน</legend>
        <?php
        if (is_array($request)) :
          if ($request['event_id']) :
            $event = $this->db
          ...
          <?php echo form_hidden('type','register'); ?>
          ...
          <div class="panel panel-success">
            <div class="panel-body">
              <div class="col-sm-8">
                ...
                <div class="form-group"> <?php echo form_label('ชื่อผู้ใช้ผลิตภัณฑ์','product_username',array('class'=>'control-label col-sm-4')); ?>
                  <div class="col-sm-8"> <?php echo form_input(array('name'=>'product_username','class'=>'form-control'),set_value('',$request['product_username'])); ?> </div>
                </div>
                <div class="form-group"> <?php echo form_label('รหัสผ่านแรกเข้า','product_password',array('class'=>'control-label col-sm-4')); ?>
                  <div class="col-sm-8"> <?php echo form_input(array('name'=>'product_password','class'=>'form-control'),set_value('',$request['product_password'])); ?> </div>
                </div>
                <div class="form-group"> <?php echo form_label('รหัสสมาชิก(ACC)','usercode',array('class'=>'control-label col-sm-4')); ?>
                  <div class="col-sm-8"> <?php echo form_input(array('name'=>'usercode','class'=>'form-control'),set_value('',$request['usercode'])); ?> </div>
                </div>
