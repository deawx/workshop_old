    ...
    <div class="col-md-12">
     ...
     <div class="col-md-12">
        <ul class="nav nav-tabs">
          <li class="active"><a href="<?php echo site_url('admin/match/match_wait'); ?>">รอการแข่งขัน <?php echo "<span class='text-danger'>[".$num_match_wait."]</span>"; ?></a> </li>
          ...
          <li><!-- เริ่มform-->
      <div class="col-sm-6">
        <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#addpoint">เพิ่มแมตช์</a>
