...
<div class="container-fluid" style="margin-top:1em;">
  <div class="row-fluid">
    ...
    <?php if ( ! $this->session->flashdata('info')) : ?>
      <h3><?php echo lang('ui_product_register'); ?></h3><hr>
      <div class="well">
        <?php echo form_open(uri_string(),array('class'=>'form-horizontal','data-toggle'=>'validator')); ?>
        <?php echo form_hidden('user_id',$this->session->id); ?>
        <?php echo form_hidden('product_id',$this->uri->segment(3)); ?>
        <?php if (isset($event)) : ?>
        ...
        <div class="form-group"><?php echo form_label(lang('form_datetime'),'datetime',array('class'=>'control-label col-sm-4')); ?>
          <div class="col-sm-8"> <div class="input-group"> <?php echo form_input(array('name'=>'datetime','class'=>'form-control datetimepicker','required'=>TRUE,'readonly'=>TRUE)); ?> <div class="input-group-addon"><i class="fa fa-lg fa-calendar"></i></div> </div> <p class="help-block"></p> </div>
        </div>
